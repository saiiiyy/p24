...
const transform9 = new Transform({
  position: new Vector3(15, 6.5, 6.657499313354492),
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.883525371551514, 4.795694828033447, 1.0005868673324585)
})
nftPictureFrame14.addComponentOrReplace(transform9)
...
nftPictureFrame18.addComponentOrReplace(transform10)
...
nftPictureFrame19.addComponentOrReplace(transform11)
...
nftPictureFrame21.addComponentOrReplace(transform12)
...
nftPictureFrame22.addComponentOrReplace(transform13)
...
nftPictureFrame23.addComponentOrReplace(transform14)
...
nftPictureFrame29.addComponentOrReplace(transform16)
...
nftPictureFrame30.addComponentOrReplace(transform17)
...
nftPictureFrame31.addComponentOrReplace(transform18)
...
nftPictureFrame33.addComponentOrReplace(transform19)
...
nftPictureFrame34.addComponentOrReplace(transform20)
...
nftPictureFrame35.addComponentOrReplace(transform21)
...
nftPictureFrame36.addComponentOrReplace(transform22)
...
const transform23 = new Transform({
  ...
  rotation: new Quaternion(-7.652455634497932e-16, -0.6958174705505371, 8.294791342677854e-8, -0.7182187438011169),
  scale: new Vector3(4.8835225105285645, 4.795694828033447, 1.0005898475646973)
})
nftPictureFrame4.addComponentOrReplace(transform23)
...
const transform25 = new Transform({
  position: new Vector3(15, 6.5, 3.5),
  rotation: new Quaternion(-1.1591285894172517e-14, 0.7191025018692017, -8.572369125658952e-8, -0.694904088973999),
  scale: new Vector3(4.883517742156982, 4.795694828033447, 1.0005871057510376)
})
nftPictureFrame37.addComponentOrReplace(transform25)
...
nftPictureFrame38.addComponentOrReplace(transform26)
...
const transform30 = new Transform({
  position: new Vector3(0.37274158000946045, 2.238152503967285, 10.463349342346191),
...
imageFromURL4.addComponentOrReplace(transform30)
...
imageFromURL5.addComponentOrReplace(transform31)
...
imageFromURL6.addComponentOrReplace(transform32)
...
imageFromURL7.addComponentOrReplace(transform33)

const imageFromURL8 = new Entity('imageFromURL8')
engine.addEntity(imageFromURL8)
imageFromURL8.setParent(_scene)
const transform34 = new Transform({
  position: new Vector3(15, 6.738152503967285, 10.300046920776367),
  rotation: new Quaternion(-1.9455749640203465e-15, -0.7071068286895752, 8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(2.000004291534424, 2, 1.000002145767212)
})
imageFromURL8.addComponentOrReplace(transform34)
...
imageFromURL9.addComponentOrReplace(transform35)
...
imageFromURL10.addComponentOrReplace(transform36)
...
const transform42 = new Transform({
  position: new Vector3(15, 16.23815155029297, 2.963348865509033),
  rotation: new Quaternion(-1.9455749640203465e-15, -0.7071068286895752, 8.429369557916289e-8, 0.7071068286895752),
  scale: new Vector3(2.0000038146972656, 2, 1.0000019073486328)
})
...
const transform43 = new Transform({
  position: new Vector3(7.608163356781006, 1.7381525039672852, 15.976869583129883),
  rotation: new Quaternion(-2.464260247952727e-15, 0, 1.088531040241566e-15, 1),
  scale: new Vector3(2.1380105018615723, 3.002318859100342, 1.0000020265579224)
})
imageFromURL19.addComponentOrReplace(transform43)

const imageFromURL20 = new Entity('imageFromURL20')
engine.addEntity(imageFromURL20)
imageFromURL20.setParent(_scene)
const transform44 = new Transform({
  position: new Vector3(2.1608777046203613, 1.7381525039672852, 15.976869583129883),
  rotation: new Quaternion(-2.464260247952727e-15, 0, 1.088531040241566e-15, 1),
  scale: new Vector3(2.1380105018615723, 3.002318859100342, 1.0000020265579224)
})
imageFromURL20.addComponentOrReplace(transform44)

const imageFromURL17 = new Entity('imageFromURL17')
engine.addEntity(imageFromURL17)
imageFromURL17.setParent(_scene)
const transform45 = new Transform({
  position: new Vector3(4.8738112449646, 1.7381525039672852, 15.976869583129883),
  rotation: new Quaternion(-2.464260247952727e-15, 0, 1.088531040241566e-15, 1),
  scale: new Vector3(2.1380105018615723, 3.002318859100342, 1.0000020265579224)
})
imageFromURL17.addComponentOrReplace(transform45)
...
script3.spawn(imageFromURL, {"image":"https://i.ibb.co/5LJS5M8/3.png"}, createChannel(channelId, imageFromURL, channelBus))
script3.spawn(imageFromURL2, {"image":"https://i.ibb.co/Hp08B4V/twitter-b159e817ee865ce610cfb21392eb1ccf.jpg"}, createChannel(channelId, imageFromURL2, channelBus))
script3.spawn(imageFromURL3, {"image":"https://i.ibb.co/Mk8tYXf/6.png"}, createChannel(channelId, imageFromURL3, channelBus))
script3.spawn(imageFromURL4, {"image":"https://i.ibb.co/0BH5Hcg/9.png"}, createChannel(channelId, imageFromURL4, channelBus))
script3.spawn(imageFromURL5, {"image":"https://i.ibb.co/fvsmc7p/11.jpg"}, createChannel(channelId, imageFromURL5, channelBus))
script3.spawn(imageFromURL6, {"image":"https://i.ibb.co/Zcw8056/14.jpg"}, createChannel(channelId, imageFromURL6, channelBus))
script3.spawn(imageFromURL7, {"image":"https://i.ibb.co/4MgRJ9t/16.png"}, createChannel(channelId, imageFromURL7, channelBus))
script3.spawn(imageFromURL8, {"image":"https://i.ibb.co/88JkjvR/19.png"}, createChannel(channelId, imageFromURL8, channelBus))
script3.spawn(imageFromURL9, {"image":"https://i.ibb.co/dtyCj2X/20.png"}, createChannel(channelId, imageFromURL9, channelBus))
script3.spawn(imageFromURL10, {"image":"https://i.ibb.co/RjQ53d1/25.png"}, createChannel(channelId, imageFromURL10, channelBus))
script3.spawn(imageFromURL11, {"image":"https://i.ibb.co/Kw0PCBg/27.png"}, createChannel(channelId, imageFromURL11, channelBus))
script3.spawn(imageFromURL12, {"image":"https://i.ibb.co/0M3CrpG/28.jpg"}, createChannel(channelId, imageFromURL12, channelBus))
script3.spawn(imageFromURL13, {"image":"https://i.ibb.co/rZQZNph/29.png"}, createChannel(channelId, imageFromURL13, channelBus))
script3.spawn(imageFromURL14, {"image":"https://i.ibb.co/G3nXkR4/15.jpg"}, createChannel(channelId, imageFromURL14, channelBus))
script3.spawn(imageFromURL15, {"image":"https://i.ibb.co/xGDF3wZ/35.png"}, createChannel(channelId, imageFromURL15, channelBus))
script3.spawn(imageFromURL16, {"image":"https://i.ibb.co/QfZ1BWb/1ac0896fa26393b7a0f49f13c7fdd43e-dat.jpg"}, createChannel(channelId, imageFromURL16, channelBus))
script3.spawn(imageFromURL19, {"image":"https://i.ibb.co/qDwkR8d/image.png"}, createChannel(channelId, imageFromURL19, channelBus))
script3.spawn(imageFromURL20, {"image":"https://i.ibb.co/qDwkR8d/image.png"}, createChannel(channelId, imageFromURL20, channelBus))
script3.spawn(imageFromURL17, {"image":"https://i.ibb.co/qDwkR8d/image.png"}, createChannel(channelId, imageFromURL17, channelBus))